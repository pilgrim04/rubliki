...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rubliki_1_billingtypes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('billing_type', self.gf('django.db.models.fields.BooleanField')()),
        ))
        ...
        db.create_table(u'rubliki_1_transactiontype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transaction_type', self.gf('django.db.models.fields.BooleanField')()),
        ))
    ...
    models = {
        ...
        u'rubliki_1.billingtypes': {
            ...
            'billing_type': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'rubliki_1.transactiontype': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'transaction_type': ('django.db.models.fields.BooleanField', [], {})
        },
        u'rubliki_1.user': {
